...
---------------------------------------------------------------------------------------------------------------------------------------------
update location
set lat =32.0880533478878, lng= 34.86782009606498
where name like N'שניידר'

update location
set lat =31.781798757201745, lng= 35.23045081281221
where name like N'באב אל עמוד'

update location
set lat =32.211776179718086, lng= 34.97871789519357
where name like N'אייל בדרך לבי"ח'

update location
set lat =31.781494379916914, lng= 35.22049668517056
where name like N'מאר יוסף'

update location
set lat =32.109292505337685, lng= 35.165315980294025
where name like N'צומת אריאל'

update location
set lat =32.07868433535578, lng= 34.79024941281817
where name like N'איכילוב'


update location
set lat =31.78109548371658, lng= 35.24602162450893
where name like N'אל מקאסד'


update location
set lat =31.55848665896736, lng= 34.543861786880456
where name like N'ארז'
...
-- Description: <to get all dic to display it in UI >
-- =============================================
CREATE PROCEDURE sp_getParamDic
...
BEGIN
    ...
    -- Insert statements for procedure here
	SELECT * from ScoreConfigDictionary
END
GO
...
-- Description: <for update the score in the config table for ride candidate>
-- =============================================
CREATE PROCEDURE sp_updateScoreById
(
    -- Add the parameters for the stored procedure here
    @id int,
	@newScore float
...
VALUES
('this_day_week',0,0.2,0),
('this_day_week',0.2,0.4,1),
('this_day_week',0.4,0.6,3),
('this_day_week',0.6,0.8,6),
('this_day_week',0.8,1,10)

INSERT INTO ScoreConfigDictionary(parameter,minRangeValue,maxRangeValue,score)
VALUES
('this_time_inDay',0,0.2,0),
('this_time_inDay',0.2,0.3,1),
('this_time_inDay',0.3,0.4,2),
('this_time_inDay',0.4,0.5,3),
('this_time_inDay',0.5,0.6,4),
('this_time_inDay',0.6,0.7,6),
('this_time_inDay',0.7,0.8,8),
('this_time_inDay',0.8,0.9,10),
('this_time_inDay',0.9,1,12)


INSERT INTO ScoreConfigDictionary(parameter,minRangeValue,maxRangeValue,score)
VALUES
('point_to_area',0,0.2,0),
('point_to_area',0.2,0.4,1),
('point_to_area',0.4,0.6,3),
('point_to_area',0.6,0.8,6),
('point_to_area',0.8,1,10)

INSERT INTO ScoreConfigDictionary(parameter,minRangeValue,maxRangeValue,score)
VALUES
('point_to_point',0,0.2,0),
('point_to_point',0.2,0.4,1),
('point_to_point',0.4,0.6,3),
('point_to_point',0.6,0.8,6),
('point_to_point',0.8,1,10)

INSERT INTO ScoreConfigDictionary(parameter,minRangeValue,maxRangeValue,score)
VALUES
('area_to_area',0,0.2,0),
('area_to_area',0.2,0.4,1),
