...
/****** Object:  StoredProcedure [dbo].[spGetUnitedRides]    Script Date: 15/10/2025 19:51:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Create Date: <03/10/2023>
-- Description: <Because of the United Tables try to Re-orgenaize this query>
-- Description: <ALTER 15/10/2025 to add another cellphone number (3)>
-- =============================================
ALTER PROCEDURE [dbo].[spGetUnitedRides]
(
    -- Add the parameters for the stored procedure here
...
WHERE 
    DATEDIFF(DAY, GETDATE(), u.PickupTime) <= @days
    AND CONVERT(DATE, u.PickupTime) >= CONVERT(DATE, GETDATE())
...
/****** Object:  StoredProcedure [dbo].[spVolunteerTypeView_GetVolunteersList_Gilad]    Script Date: 29/10/2025 07:10:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
