...
-- =============================================
	...
	AS
		BEGIN
			...
			SELECT
			MainDriver as Id,V.DisplayName, V.NoOfDocumentedCalls, IsSuperDriver, AmmountOfMatchDayPart, AmmountOfDisMatchDayPart, AmmountOfPathMatchScoreOfType_0,
			...
			SELECT 
			V.Id, V.DisplayName, V.NoOfDocumentedCalls, 0 AS IsSuperDriver,
