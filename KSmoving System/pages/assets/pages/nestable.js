...
!function ($) {
    ...
    Nestable.prototype.init = function () {
        ...
        //this.updateOutput($('#nestable_list_3').data('output', $('#nestable_list_3_output')));
        //this.updateOutput($('#nestable_list_4').data('output', $('#nestable_list_4_output')));
        //this.updateOutput($('#nestable_list_6').data('output', $('#nestable_list_6_output')));
        //this.updateOutput($('#nestable_list_10').data('output', $('#nestable_list_10_output')));
        //this.updateOutput($('#nestable_list_11').data('output', $('#nestable_list_11_output')));
