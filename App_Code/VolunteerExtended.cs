...
public class VolunteerExtended : Volunteer
{
    ...
    public void setVolunteerData(VolunteerExtended v, string username)
    {
        ...
        cmdParams[15] = cmd.Parameters.AddWithValue("@englishName", v.EnglishName);
        cmdParams[16] = cmd.Parameters.AddWithValue("@username", username);
        ...
        query += "BirthDate=@bDay, IsDriving=@isDriving, HowCanHelp=@howCanHelp, Feedback=@feedback, Remarks=@remarks, ";
